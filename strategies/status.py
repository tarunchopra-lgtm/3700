...
def close_position_by_symbol(symbol: str):
    try:
        ...
        print(f"  âœ“ Closed {symbol} at market price. Order ID: {getattr(response, 'id', 'N/A')}")
        return True
    except Exception as e:
...
def close_all_displayed_positions(positions):
    ...
    print(f"  âœ“ Closed {closed}/{len(positions)} position(s)")

print(f"\nâ•”{'â•'*62}â•—")
print(f"â•‘  ACCOUNT STATUS  {'Paper' if PAPER else 'Live':>6} | {datetime.now().strftime('%Y-%m-%d %H:%M:%S'):<20}  â•‘")
if SYMBOL_FILTER:
    print(f"â•‘  Filter: {SYMBOL_FILTER:<52}â•‘")
print(f"â•š{'â•'*62}â•")

print_account_balance()

# â”€â”€ OPEN ORDERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
print(f"\n{'â”€'*64}")
print(f"  OPEN ORDERS")
print(f"{'â”€'*64}")
try:
...
# â”€â”€ FILLED ORDERS TODAY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
print(f"\n{'â”€'*64}")
...
try:
    ...
    print(f"  âœ— Error fetching filled orders: {e}")

# â”€â”€ CURRENT POSITIONS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
print(f"\n{'â”€'*64}")
        ...
        if choice.isdigit():
            ...
            if 1 <= index <= len(positions):
                ...
                if confirm == 'Y':
                    ...
                    print("  Cancelled.")
                break
            print(f"  âœ— Invalid selection. Choose 1-{len(positions)}, A, R, or Q.")
            continue
        print(f"  âœ— Invalid input. Choose 1-{len(positions)}, A, R, or Q.")
